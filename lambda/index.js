...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, you can say Hello to see a Welcome Text or say, Show me a button, to see the magic! Which would you like to try?';
...
const ButtonEventHandler = {
    ...
    handle(handlerInput){
        ...
        const speakOutput = "Thank you for clicking the button. " + buttonMessage;
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .getResponse();
    }
